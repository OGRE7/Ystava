...
class ContributionsControllerTest < ActionController::TestCase
  ...
  test "should create contribution" do
    assert_difference('Contribution.count') do
      post :create, contribution: { description: @contribution.description, somme: @contribution.somme, utilisateur_id: @contribution.utilisateur_id }
    end
  ...
  test "should update contribution" do
    put :update, id: @contribution, contribution: { description: @contribution.description, somme: @contribution.somme, utilisateur_id: @contribution.utilisateur_id }
    assert_redirected_to contribution_path(assigns(:contribution))
  end
